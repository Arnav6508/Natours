...
var hideAlert = exports.hideAlert = function hideAlert() {
  ...
  el === null || el === void 0 || el.parentElement.removeChild(el);
};
...
updateSettingsForm === null || updateSettingsForm === void 0 || updateSettingsForm.addEventListener('submit', function (e) {
  e.preventDefault();
